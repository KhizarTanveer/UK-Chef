        ...
        <div className="editorial-split">
          ...
          <div className="gsap-mid" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div className="network-cards-grid">
              ...
              {/* Households */}
              <div className="contact-glass-card gsap-fg" style={{ padding: '30px' }}>
                <div style={{ color: 'var(--color-premium-gold)', marginBottom: '15px' }}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>
                  </svg>
                </div>
                <div className="contact-card-label" style={{ color: 'var(--color-brand-red)' }}>Consumer</div>
                <div className="contact-card-info" style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Households</div>
                <div style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', lineHeight: 1.5 }}>Bringing authentic, premium taste to everyday family meals.</div>
              </div>
              ...
              <div className="contact-glass-card gsap-fg" style={{ padding: '30px' }}>
                ...
                <div className="contact-card-label" style={{ color: 'var(--color-brand-red)' }}>Commercial</div>
                <div className="contact-card-info" style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Restaurants & HORECA</div>
                <div style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', lineHeight: 1.5 }}>The trusted, standardized choice for professional executive chefs.</div>
              </div>
              ...
              <div className="contact-glass-card gsap-fg" style={{ padding: '30px' }}>
                ...
                <div className="contact-card-label" style={{ color: 'var(--color-brand-red)' }}>Distribution</div>
                <div className="contact-card-info" style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Retailers & Wholesale</div>
                <div style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', lineHeight: 1.5 }}>Reliable supply chains and beautiful, premium shelf packaging.</div>
              </div>
              ...
              <div className="contact-glass-card gsap-fg" style={{ padding: '30px' }}>
                ...
                <div className="contact-card-label" style={{ color: 'var(--color-brand-red)' }}>Industrial</div>
                <div className="contact-card-info" style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Food Businesses</div>
                <div style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', lineHeight: 1.5 }}>Customized bulk supply solutions for large scale industrial use.</div>
              </div>
